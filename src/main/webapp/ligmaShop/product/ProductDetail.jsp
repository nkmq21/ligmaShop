            ...
            <div class="review-list">
                ...
                <div class="review-item">
                    ...
                    <div>
                        ...
                        <p class="rating">★★★★☆</p>
                        <p>Hàng đẹp nhưng giao hơi lâu.</p>
                    </div>
                </div>
                ...
                <div class="review-item">
                    ...
                    <div>
                        <p><strong>Phạm Văn C</strong></p>
                        <p class="rating">★★★☆☆</p>
                        <p>Sản phẩm ổn, nhưng cần cải thiện chất lượng đóng gói.</p>
                    </div>
                </div>
                    ...
                    <div class="footer__download">
                        ...
                        <div class="footer__download-apps">
                            <a href="" class="footer__download-apps-link">
                                <img src="${pageContext.request.contextPath}/images/1fddd5ee3e2ead84.png"
                                     alt="Goggle play" class="footer__download-apps-img">
                            </a>
                            <a href="" class="footer__download-apps-link">
                                <img src="${pageContext.request.contextPath}/images/135555214a82d8e1.png" alt="AppStore"
