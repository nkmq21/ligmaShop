                                ...
                                <ul class="category-list">
                                    <c:forEach items="${category}" var="o">
                                        <li class="category-item ${param.cID == o.categoryID ? 'category-item--active' : ''}">
                                            <a href="products?cID=${o.categoryID}&page=1&query=rong&weather=all"
                            ...
                            <div class="home-filter hide-on-mobile-tablet">
                                ...
                                <div class="select-input">
                                    ...
                                    <form action="${pageContext.request.contextPath}/products" method="GET">
                                        <input type="hidden" name="cID" value="${param.cID != null ? param.cID : ''}">
                                    ...
                                    <ul class="pagination home-product__pagination">
                                        <li class="pagination-item">
                                            <c:if test="${currentPage > 1}">
                                                <a href="products?page=${currentPage - 1}&cID=${param.cID}&query=${param.query}&weather=${requestScope.weather}"
                                        ...
                                        <c:forEach var="i" begin="1" end="${totalPages}">
                                            <li class="pagination-item ${currentPage == i ? 'pagination-item--active' : 1}">
                                                <a href="products?page=${i}&cID=${param.cID != null ? param.cID : 1}&query=${param.query}&weather=${requestScope.weather}"
                                                   class="pagination-item__link">${i}</a>
                                            </li>
                                        </c:forEach>
                                        <li class="pagination-item">
                                            <c:if test="${currentPage < totalPages}">
                                                <a href="products?page=${currentPage + 1}&cID=${param.cID != null ? param.cID : 1}&query=${param.query}&weather=${requestScope.weather}"
                                                   class="pagination-item__link">
